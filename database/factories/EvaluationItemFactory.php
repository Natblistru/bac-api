...
HTML;
        ...
        $ev_items = [
            ...
            ["order_number" => 3,  "evaluation_source_id" => 1,  "task" => $task3, "subtopic_id" => 7],
            ["order_number" => 4,  "evaluation_source_id" => 1,  "task" => $task4, "subtopic_id" => 8],
            ["order_number" => 5,  "evaluation_source_id" => 1,  "task" => $task5, "subtopic_id" => 9],
            ["order_number" => 6,  "evaluation_source_id" => 1,  "task" => $task6, "subtopic_id" => 10],
            ["order_number" => 7,  "evaluation_source_id" => 1,  "task" => $task7, "subtopic_id" => 11],
            ["order_number" => 8,  "evaluation_source_id" => 1,  "task" => $task8, "subtopic_id" => 13],
            ["order_number" => 9,  "evaluation_source_id" => 1,  "task" => $task9, "subtopic_id" => 12],
            ["order_number" => 10,  "evaluation_source_id" => 2,  "task" => null, "subtopic_id" => 14],  
            ["order_number" => 11,  "evaluation_source_id" => 3,  "task" => null, "subtopic_id" => 15], 
            ["order_number" => 12,  "evaluation_source_id" => 4,  "task" => null, "subtopic_id" => 16],     
